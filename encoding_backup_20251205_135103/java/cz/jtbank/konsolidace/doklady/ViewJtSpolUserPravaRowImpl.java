    ...
    while(iter.hasNext()) 
    {
      ...
      if(dokladExists) {
        ...
        if(name.startsWith("Bilance") && name.indexOf("Detail")<0) {
          ...
          {
            if(!manFlag) buf.append("&nbsp;<a href=\"DokladyGenSub.jsp?idDoklad="+idDoklad+"\" title=\"Pøegenerovat\">G</a>");
            if(getIdKtgodbor()==null && getIdKtgprojekt()==null && name.indexOf("Sub")<0/* && name.indexOf("2005")>0*/) {
              buf.append("&nbsp;<a href=\"DokladManProjektOdbor2.jsp?idDoklad="+idDoklad+"\" title=\"Víceprojektové/odborové poèáteèní stavy\">PS</a>");
            }
          }
        }
