...
public class ESExportBilanceDetail extends AbsExcelDoklad 
{
  ...
  private void outputDetail()
  {
    ...
    String nadpis = "Detail bilance "+ nazevSpol +" / "+ menaSpol +" k "+ dDatum +", m�stek z "+dDatumMustek;
    ...
    colNr=0;
    setCellValue( listNr, rowNr, colNr, "Intern� ID" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "��dek text" , lightBlue ); colNr++;
    ...
    setCellValue( listNr, rowNr, colNr, "��stka lok�ln�" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "��stka v m�n�" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "Extern� ID" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "Popis" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "Datum" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "Vybran� protistrana" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "Protistrana" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "Protistrana I�" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "Banka" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "Banka I�" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "Ekon. objekt" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "Ekon. objekt I�" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "Emitent" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "Emitent I�" , lightBlue ); colNr++;
    ...
    setCellValue( listNr, rowNr, colNr, "M�nov� pozice" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "�v�rov� pozice" , lightBlue ); colNr++;
