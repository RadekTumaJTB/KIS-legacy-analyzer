...
public class ESExportDoklad2007 extends AbsExcelDoklad 
{
  ...
  private void init() {
    ...
    {
      logger.warn("Neexistuje podnikatelsk� doklad IFRS pro "+idKtgUcetniSpolecnost+" a "+datum);
    }
    vo.closeRowSet();
    ...
    {
      logger.warn("Neexistuje podnikatelsk� doklad Local pro "+idKtgUcetniSpolecnost+" a "+datum);
    }
    vo.closeRowSet();
...
/*        else if(pozice.list==2) {
      ...
      case 6: //17
        ...
        break;
      default:
        logger.error("Nezn�m� druh dokladu:" + dokladTyp);
    }
