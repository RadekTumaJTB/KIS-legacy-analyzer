...
/*  
    try {
      String s = URLEncoder.encode("Senov�n� n�m�st� 32 pracovn� zpr�va k 12.10.2005.doc","windows-1250");
...
*/
  ...
  public void deleteUcSkup() throws KisException
  {
    try (Statement st = getDBTransaction().createStatement(0))
    {
      ...
      throw new KisException("Selhalo vol�n� procedury deleteUcSkup()",s);
    }
  }
                           ...
                           int idCis) throws KisException
  {
    try (Statement st = getDBTransaction().createStatement(0))
    {
      ...
      s.printStackTrace(); //pro zacatek
      throw new KisException("Selhalo vol�n� procedury insertUcSkup()",s);
    }
  }
                                ...
                                int idMngSeg) throws KisException
  {
    if(!isAdmin && "I".equals(akce)) 
    {
      ...
      {
        throw new KisException("U�ivatel s Va�imi opr�vn�n�mi m��e nastavovat jen manu�ln� spole�nosti. Syst�m tedy mus� b�t 'M'.",
              new KisException(Constants.ERR_MESSAGE_ONLY));
      }
      if(900!=idDatabaze) 
      {
        throw new KisException("U�ivatel s Va�imi opr�vn�n�mi m��e nastavovat jen manu�ln� spole�nosti. DB Link tedy mus� b�t 'Manual'.",
              new KisException(Constants.ERR_MESSAGE_ONLY));
      }
    }
    ...
    {
      souborPredpona = souborPredpona.replaceAll("[��]","a");
      souborPredpona = souborPredpona.replaceAll("[��]","c");
      souborPredpona = souborPredpona.replaceAll("[��]","d");
      souborPredpona = souborPredpona.replaceAll("[��]","e");
      souborPredpona = souborPredpona.replaceAll("[��]","e");
      souborPredpona = souborPredpona.replaceAll("[��]","i");
      souborPredpona = souborPredpona.replaceAll("[��]","n");
      souborPredpona = souborPredpona.replaceAll("[��]","o");
      souborPredpona = souborPredpona.replaceAll("[��]","r");
      souborPredpona = souborPredpona.replaceAll("[��]","s");
      souborPredpona = souborPredpona.replaceAll("[��]","t");
      souborPredpona = souborPredpona.replaceAll("[��]","u");
      souborPredpona = souborPredpona.replaceAll("[��]","u");
      souborPredpona = souborPredpona.replaceAll("[��]","y");
      souborPredpona = souborPredpona.replaceAll("[��]","z");
      souborPredpona = souborPredpona.replaceAll("\\W","_");
    }
    
    List list = new ArrayList();
    if(nazev==null || nazev.length()==0) { list.add("N�zev"); }
    if(ico==null || ico.length()==0) { list.add("I�"); }
    if(souborPredpona==null || souborPredpona.length()==0) { list.add("Adres�� soubor�"); }
    //if(dbLink==null || dbLink.length()==0) { list.add("DB - Link"); }
    if(extSystem==null || extSystem.length()==0) { list.add("Syst�m (T|S|Q|M)"); }
    if(list.size() > 0) 
    {
      StringBuffer buf = new StringBuffer("Chyb� n�sleduj�c� povinn� nebo pot�ebn� �daje: ");
    ...
    else 
    {
      try 
      {
        ...
        s.printStackTrace(); //pro zacatek
        throw new KisException("Selhalo vol�n� procedury processSpolecnost()",s);
      }
      finally {
        try {
          if (st != null) st.close();
    ...
    try 
    {
      ...
      if("I".equals(akce)) {
        ...
        if(idUcetni>0) mail.sendNewSpolecnost(this,idSpol,nazev,idUcetni,"zodpov�dn�/� ��etn�",osoby,idMngSeg);
        if(idOdpovednaosoba>0) mail.sendNewSpolecnost(this,idSpol,nazev,idOdpovednaosoba,"odpov�dn� osoba",osoby,idMngSeg);
        if(idAdministrator>0) mail.sendNewSpolecnost(this,idSpol,nazev,idAdministrator,"administr�tor/ka",osoby,idMngSeg);
        //if(idTopmng>0) mail.sendNewSpolecnost(this,idSpol,nazev,idTopmng,"top manager/ka",osoby);
      }
      else if("U".equals(akce)) {
        Mail mail = new Mail();
        if(idUcetni!=origUcetni) mail.sendChngSpolecnost(this,idSpol,nazev,idUcetni,origUcetni,"zodpov�dn�/� ��etn�",osoby,idMngSeg);
        if(idOdpovednaosoba!=origOO) mail.sendChngSpolecnost(this,idSpol,nazev,idOdpovednaosoba,origOO,"odpov�dn� osoba",osoby,idMngSeg);
        if(idAdministrator!=origAdmin) mail.sendChngSpolecnost(this,idSpol,nazev,idAdministrator,origAdmin,"administr�tor/ka",osoby,idMngSeg);
    ...
    if(country!=null) {
      try 
      {
        ...
        s.printStackTrace(); //pro zacatek
        throw new KisException("Selhalo vol�n� procedury processSpolecnost() - country",s);
      }
      finally {
        try {
          if (st != null) st.close();
...
*/    
                              ...
                              double vyuzDanZtr)  throws KisException 
  {
    ...
    try 
    {
      ...
      s.printStackTrace(); //pro zacatek
      throw new KisException("Selhalo vol�n� procedury setDanovaZtrata()",s);
    }
    finally {
      try {
        if (st != null) st.close();
                        ...
                        int freqDPH)  throws KisException 
  {
    ...
    try 
    {
      ...
      s.printStackTrace(); //pro zacatek
      throw new KisException("Selhalo vol�n� procedury setOdhady()",s);
    }
    finally {
      try {
        if (st != null) st.close();
                          ...
                          java.sql.Date platnostDo) throws KisException
  {
    ...
    try {
      ...
      s.printStackTrace(); //pro zacatek
      throw new KisException("Selhalo vol�n� procedury db_jt.kap_gui.p_KpDatDanoveSazby",s);
    }
    finally {
      try {
        if (st != null) st.close();
                       ...
                       String priznani)  throws KisException 
  {
    ...
    try 
    {
      ...
      s.printStackTrace(); //pro zacatek
      throw new KisException("Selhalo vol�n� procedury setAudit()",s);
    }
    finally {
      try {
        if (st != null) st.close();
                              ...
                              java.sql.Date datum) throws KisException
  {
    ...
    try {
      ...
      s.printStackTrace(); //pro zacatek
      throw new KisException("Selhalo vol�n� procedury db_jt.kap_guiv.p_KpKtgUcSpolPredavani",s);
    }
    finally {
      try {
        if (st != null) st.close();
                                 ...
                                 int typOO) throws KisException
  {
    ...
    try {
      ...
      s.printStackTrace(); //pro zacatek
      throw new KisException("Selhalo vol�n� procedury db_jt.kap_guiv.p_predavaniSchvaleno",s);
    }
    finally {
      try {
        if (st != null) st.close();
                     ...
                     String idFeisPrenos) throws KisException
  {
    ...
    if("I".equals(akce)) {
      try {
        ...
        s.printStackTrace(); //pro zacatek
        throw new KisException("Selhalo vol�n� procedury dbLink akce="+akce,s);
      }
      finally {
        try {
          if (st != null) st.close();
                            ...
                            String idOdbor) throws KisException
  {
    ...
    try {
      ...
      s.printStackTrace(); //pro zacatek
      throw new KisException("Selhalo vol�n� procedury db_jt.kap_guiv.p_quaestorProjektOdbor",s);
    }
    finally {
      try {
        if (st != null) st.close();
                    ...
                    java.sql.Date dtZprava) throws KisException
  {
    ...
    if("I".equals(akce)) {
      try {
        ...
        s.printStackTrace(); //pro zacatek
        throw new KisException("Selhalo vol�n� procedury karta akce="+akce,s);
      }
      finally {
        try {
          if (st != null) st.close();
                       ...
                       String popis) throws KisException
  {
    ...
    if("I".equals(akce)) {
      try {
        ...
        s.printStackTrace(); //pro zacatek
        throw new KisException("Selhalo vol�n� procedury kartaTyp akce="+akce,s);
      }
      finally {
        try {
          if (st != null) st.close();
                            ...
                            java.sql.Date dtDo) throws KisException
  {
    ...
    if("I".equals(akce)) {
      try {
        ...
        s.printStackTrace(); //pro zacatek
        throw new KisException("Selhalo vol�n� procedury kartaPravidla akce="+akce,s);
      }
      finally {
        try {
          if (st != null) st.close();
                            ...
                            int idSpol) throws KisException
  {
    ...
    if("I".equals(akce)) {
      try {
        ...
        s.printStackTrace(); //pro zacatek
        throw new KisException("Selhalo vol�n� procedury kartaVyjimky akce="+akce,s);
      }
      finally {
        try {
          if (st != null) st.close();
                                         ...
                                         java.sql.Date datum) throws KisException
  {
    ...
    try {
      ...
      s.printStackTrace(); //pro zacatek
      throw new KisException("Selhalo vol�n� funkce db_jt.jeSpolecnostClenSkupiny",s);
    }
    finally {
      try {
        if (st != null) st.close();
                          ...
                          String zprava) throws KisException
  {
    ...
    if(idZprava==0) {
      try {
        ...
        s.printStackTrace(); //pro zacatek
        throw new KisException("Selhalo vol�n� procedury kartaZprava id=0",s);
      }
      finally {
        try {
          if (st != null) st.close();
    ...
    //UPDATE
      ...
      try {
        ...
        s.printStackTrace(); //pro zacatek
        throw new KisException("Selhalo vol�n� procedury kartaZprava id="+idZprava,s);
      }
      finally {
        try {
          if (st != null) st.close();
                            ...
                            int perioda) throws KisException
  {
    ...
    try {
      ...
      s.printStackTrace(); //pro zacatek
      throw new KisException("Selhalo vol�n� procedury setKartaDatum idSpol="+idSpol+",idKartaTyp="+idKartaTyp,s);
    }
    finally {
      try {
        if (st != null) st.close();
