...
public class DokumentModuleImpl extends ApplicationModuleImpl implements cz.jtbank.konsolidace.dokument.common.DokumentModule 
{
  ...
  private int currentUsersCisDocUcSpol() 
  {
    ...
    if(voUser.hasNext()) 
    {
      ...
      /*0	Všechno
        1	Odbory spoleènosti
        2	Odbory povolených spoleèností
        3	Odbory dle zemì
       * */
    }
    voUser.closeRowSet();
                        ...
                        int typOO) throws KisException
  {
    ...
    try {
	  ...
	  if ( vOraErr == 20777 ) {	    
			...
			zamitnoutRadek( akce, idRadek, "Automatické zamietnutie! V Nezaøazeno nie je dostatok prostriedkov. Žiadajte navýšenie mimo rezervy.") ;											
