# Proces: DokladyProcess

**Vstupní bod:** DokladyProcess

## Přehled procesu

Tento business proces začíná na stránce **DokladyProcess** a pokračuje přes 5 dalších kroků.
...
4. Zpracování → Zpracování → Zpracování → DokladyManStarsi
