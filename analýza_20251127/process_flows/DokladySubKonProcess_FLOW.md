# Business proces: DokladySubKonProcess

**Vstupní stránka:** DokladySubKonProcess
...
1. DokladySubKonProcess → DokladyProcessGen → DokladyProcessGen → DokladySpol
2. DokladySubKonProcess → DokladyProcessGen → DokladyProcessGen → Doklady
3. DokladySubKonProcess → DokladyProcessGen → DokladyProcessGen → DokladyManStarsi
4. DokladySubKonProcess → DokladyProcessGen → DokladyProcessGen → DokladyMan
