...
public class ESExportSlTypizovanePouzite  {	public ESExportSlTypizovanePouzite() {	}
	public static void main(String[] args) {		ESExportSlTypizovanePouzite eSExportSlTypizovanePouzite = new ESExportSlTypizovanePouzite();	}}
*/
package cz.jtbank.konsolidace.excel;
...
public class ESExportSlTypizovanePouzite extends AbsExcelDoklad 
{
  static Logger logger = Logger.getLogger(ESExportSlTypizovanePouzite.class);
  ...
  public ESExportSlTypizovanePouzite(ApplicationModule dokladyModule,
                       java.sql.Date datum)
  {
    logger.info("ESExportSlTypizovanePouzite:datum="+datum);  
    dm = dokladyModule;
    this.datum = datum;
  ...
  private void init() {
    setFileName ( "SL_Typizovane_pouzite_"+datum+".xlsx" );
    setFileRelativeName( dir+"\\"+getFileName() );
    setFileAbsoluteName( OUT_DIR + this.getFileRelativeName() );
    setSablona( Constants.SABLONY_FILES_PATH+"Empty.xlsx" );
logger.info("ESExportSlTypizovanePouzite:cesta="+this.getFileAbsoluteName());  	
  }
  
  private void outputSLPouzite() {
  ...
  protected boolean outputData () 
  {
      ...
      logger.debug("SLPostup:"+((end-start)/1000.0)+"s");
...
//      ESExportSLPostup ed = new ESExportSLPostup(dm,new java.sql.Date(System.currentTimeMillis()));
      ESExportSlTypizovanePouzite ed = new ESExportSlTypizovanePouzite(dm,new java.sql.Date(System.currentTimeMillis()));
      ed.excelOutput();
