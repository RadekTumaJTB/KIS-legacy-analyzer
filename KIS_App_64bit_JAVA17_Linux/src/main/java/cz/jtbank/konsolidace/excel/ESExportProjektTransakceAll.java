...
public class ESExportProjektTransakceAll extends AbsExcelDoklad 
{
  ...
  private void outputProjekty() {
    ...
    setCellValue( listNr, rowNr, colNr, "Nďż˝KLADY PROJEKTďż˝" , styleBold );
    rowNr+=2;
    ...
    setCellValue( listNr, rowNr, colNr, "Nďż˝zev projektu" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "Popis" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "ďż˝ďż˝stka" , lightBlue ); colNr++;
    ...
    setCellValue( listNr, rowNr, colNr, "Spoleďż˝nost" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "Dodavatelďż˝" , lightBlue ); colNr++;
    ...
    setCellValue( listNr, rowNr, colNr, "TRANSAKCE PROJEKTďż˝ " , styleBold );
    rowNr+=2;
    ...
    setCellValue( listNr, rowNr, colNr, "Mďż˝na" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "ďż˝ďż˝stka local" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "Datum" , lightBlue ); colNr++;
    setCellValue( listNr, rowNr, colNr, "Spoleďż˝nost" , lightBlue ); colNr++;
